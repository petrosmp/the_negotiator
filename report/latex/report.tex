	...
	\section{Implementation}		\label{sec:implementation}
		...
		\subsection{High Level Overview}	\label{sec:implementation.high_level_view}
			...
			\paragraph*{}
				...
				\begin{itemize}
					\item In a never-before-seen domain, we feed its characteristics (see \quotes{features} below) % TODO: add a reference here to where we explain what features we used.
